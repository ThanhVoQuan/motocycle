		...
		<div class="section group">
			<div class="col_1_of_4 span_1_of_4">
				...
				<div class="prod-inner">
					...
					<a href="single.html" class="button" rel="nofollow">Add to cart</a>
					<div class="clear"></div> 
				</div>
			</div>			
			<div class="col_1_of_4 span_1_of_4">
		...
		<div class="content-bottom">
			...
			<div class="col_1_of_3 span_1_of_3">
				<div class="banner-wrap bottom_banner">
					<a href="#" class="main_link">
					<figure><img src="images/phone.png" alt=""/></figure><h5>Order online <br><span>1(800) 234-5678</span></h5><p>Hours: 8am-11pm PST M-Th; 8am-9pm PST Fri<br>
					</p></a>
				</div>
			</div>
			<div class="col_1_of_3 span_1_of_3">
				<div class="banner-wrap bottom_banner color_dark">
					<a href="#" class="main_link">
					<figure><img src="images/gift.png" alt=""/></figure><h5>Discount</h5><p>Choose from any of our extensive range </p></a>
				</div>
			</div>
			<div class="clear"></div> 
		</div>